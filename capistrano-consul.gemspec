...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Plugin to use a consul server/cluster to define capistrano servers.}
  spec.description   = %q{This plugin allow using a consul server to automatically set up servers.}
